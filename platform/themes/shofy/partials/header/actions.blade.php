<div @class(['tp-header-action d-flex align-items-center', $class ?? null])>
    @if(isset($showSearchButton) && $showSearchButton)
        <div class="tp-header-action-item d-none d-sm-block tp-header-action-item-search">
            <button type="button" class="tp-header-action-btn tp-search-open-btn" aria-label="{{ __('Open search') }}">
    ...
    @if(is_plugin_active('ecommerce'))
        ...
        @if (EcommerceHelper::isCartEnabled())
            <div class="tp-header-action-item tp-header-action-item-cart">
                <button type="button" class="tp-header-action-btn cartmini-open-btn" data-bb-toggle="open-mini-cart" data-url="{{ route('public.ajax.cart-content') }}" aria-label="{{ __('View cart') }}">
    ...
    <div class="tp-header-action-item d-lg-none tp-header-action-item-menu">
        <button type="button" class="tp-header-action-btn tp-offcanvas-open-btn" aria-label="{{ __('Open menu') }}">
