...
class Payment extends BaseModel
{
    ...
    protected $fillable = [
        ...
        'refunded_amount',
        'refund_note',
        'sepay_webhook_transaction_id',
        'sepay_api_transaction_id',
    ];
    ...
    public function getPaymentLogs()
    {
        ...
        return PaymentLog::query()
            ...
            ->where(function ($query): void {
                $query->where('payment_id', $this->getKey())
                    ->orWhere('charge_id', $this->charge_id)
                    ->orWhere('request', 'LIKE', '%' . $this->charge_id . '%')
