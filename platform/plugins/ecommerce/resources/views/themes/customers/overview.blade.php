...
@section('content')
    ...
    <div class="bb-customer-profile-wrapper">
        <div class="bb-customer-profile">
            <div class="row align-items-center">
                ...
                <div class="col">
                    <div class="bb-customer-profile-info text-md-center text-start d-none">
                        <h2 class="h4 mb-2">
                    ...
                    <!-- <div class="text-md-left">
                            ...
                            <div class="d-flex">
                                <p class="text-muted mb-0 me-3"><span class="fw-bold">3</span> bài viết</p>
                                <p class="text-muted mb-0 me-3"><span class="fw-bold">3</span> người theo dõi</p>
                                <p class="text-muted mb-0 me-3">Đang theo dõi <span class="fw-bold">3</span> người dùng</p>
                            </div>
                    </div> -->
                    @if (is_plugin_active('social-network'))
                        @include('plugins/social-network::customers.profile.information')
                    @else
    ...
    @if (is_plugin_active('social-network'))
        @include('plugins/social-network::customers.profile.profile-media-grid')
    @endif
