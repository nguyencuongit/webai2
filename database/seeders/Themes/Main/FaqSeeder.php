...
class FaqSeeder extends ThemeSeeder
{
    public function run(): void
    {
        ...
        foreach ($categories as $index => $value) {
            $value['order'] = $index;
            $createdCategories[] = FaqCategory::query()->create($value);
        }
        ...
        $faqItems = [
            [
                ...
                'category_id' => $createdCategories[0]->getKey(),
            ],
            [
            ...
            [
                ...
                'category_id' => $createdCategories[1]->getKey(),
            ],
            [
            ...
            [
                ...
                'category_id' => $createdCategories[2]->getKey(),
            ],
            [
